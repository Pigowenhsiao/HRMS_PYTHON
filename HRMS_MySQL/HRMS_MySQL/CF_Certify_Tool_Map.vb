Public Class CF_Certify_Tool_Map
    ...
    Sub GetData()
        ...
        strSQL &= "  trim(A.Remark) as 備註,  A.Active, trim(B.Certify_Type) as 屬性 "
        strSQL &= " from Certify_Tool_Map A, Certify_items B where A.Active =true and B.active=true "
    ...
    Private Sub CF_Certify_Tool_Map_Resize(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Resize
        ...
        DGV_Certify_CFTM.Height = Me.Height - 300
    ...
    Private Sub CF_Certify_Tool_Map_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        strSQL = ""
        strSQL = " select distinct trim(Certify_ID) from Certify_items  order by trim(Certify_ID) "
...
Err_Handle:
    ...
    Private Sub BT_Certify_Export_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BT_Certify_Export.Click


        Call Excel_Export(DGV_Certify_CFTM)
