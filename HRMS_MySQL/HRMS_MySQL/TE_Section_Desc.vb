...
Err_Handle:
    ...
    Private Sub DGV_Section_CellContentClick(ByVal sender As System.Object, ByVal e As System.Windows.Forms.DataGridViewCellEventArgs) Handles DGV_Section.CellContentClick
    ...
    Private Sub BT_Section_GetData_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles BT_Section_GetData.Click
        Dim strSQL As String
        Dim objDataset As DataSet
        On Error GoTo Err_Handle
